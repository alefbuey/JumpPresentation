...
--DROP
ALTER TABLE UserJump DROP CONSTRAINT FKUserJump139442;
ALTER TABLE Employee DROP CONSTRAINT FKEmployee996956;
ALTER TABLE Employee_TagJump DROP CONSTRAINT FKEmployee_T827862;
ALTER TABLE Employee_TagJump DROP CONSTRAINT FKEmployee_T803399;
ALTER TABLE Employer DROP CONSTRAINT FKEmployer996969;
ALTER TABLE Employer DROP CONSTRAINT FKEmployer290876;
ALTER TABLE Employee DROP CONSTRAINT FKEmployee290889;
ALTER TABLE Job DROP CONSTRAINT FKJob21280;
ALTER TABLE Job DROP CONSTRAINT FKJob218444;
ALTER TABLE Job DROP CONSTRAINT FKJob67976;
ALTER TABLE EmployeeJob DROP CONSTRAINT FKEmployeeJo204629;
ALTER TABLE EmployeeJob DROP CONSTRAINT FKEmployeeJo483457;
ALTER TABLE Job_TagJump DROP CONSTRAINT FKJob_TagJum687162;
ALTER TABLE Job_TagJump DROP CONSTRAINT FKJob_TagJum990453;
ALTER TABLE Job DROP CONSTRAINT FKJob50815;
ALTER TABLE UserJump DROP CONSTRAINT FKUserJump698533;
ALTER TABLE Comment DROP CONSTRAINT FKComment369264;
ALTER TABLE Comment DROP CONSTRAINT FKComment890759;
ALTER TABLE Comment DROP CONSTRAINT FKComment218269;
ALTER TABLE UserStaff DROP CONSTRAINT FKUserStaff243811;
ALTER TABLE JobAddress DROP CONSTRAINT FKJobAddress850771;
ALTER TABLE ChatLine DROP CONSTRAINT FKChatLine684908;
ALTER TABLE ChatLine DROP CONSTRAINT FKChatLine359812;
ALTER TABLE TagJump DROP CONSTRAINT FKTagJump445836;
ALTER TABLE EmployeeJob DROP CONSTRAINT FKEmployeeJo623179;
ALTER TABLE UserJump DROP CONSTRAINT FKUserJump746039;
ALTER TABLE FavoritesJobs DROP CONSTRAINT FKFavoritesJ937340;
ALTER TABLE FavoritesJobs DROP CONSTRAINT FKFavoritesJ658512;
ALTER TABLE Followers DROP CONSTRAINT FKFollowers802750;
ALTER TABLE Followers DROP CONSTRAINT FKFollowers802736;
ALTER TABLE TransactionJump DROP CONSTRAINT FKTransactio399029;
ALTER TABLE JobPhotos DROP CONSTRAINT FKJobPhotos830987;
DROP TABLE IF EXISTS Card CASCADE;
DROP TABLE IF EXISTS Category CASCADE;
DROP TABLE IF EXISTS Chat CASCADE;
DROP TABLE IF EXISTS ChatLine CASCADE;
DROP TABLE IF EXISTS Comment CASCADE;
DROP TABLE IF EXISTS Employee CASCADE;
DROP TABLE IF EXISTS Employee_TagJump CASCADE;
DROP TABLE IF EXISTS EmployeeJob CASCADE;
DROP TABLE IF EXISTS EmployeeState CASCADE;
DROP TABLE IF EXISTS Employer CASCADE;
DROP TABLE IF EXISTS FavoritesJobs CASCADE;
DROP TABLE IF EXISTS Followers CASCADE;
DROP TABLE IF EXISTS Job CASCADE;
DROP TABLE IF EXISTS Job_TagJump CASCADE;
DROP TABLE IF EXISTS JobAddress CASCADE;
DROP TABLE IF EXISTS JobMode CASCADE;
DROP TABLE IF EXISTS JobPhotos CASCADE;
DROP TABLE IF EXISTS JobState CASCADE;
DROP TABLE IF EXISTS Location CASCADE;
DROP TABLE IF EXISTS NationalIdentifierType CASCADE;
DROP TABLE IF EXISTS PaypalAccount CASCADE;
DROP TABLE IF EXISTS Ranking CASCADE;
DROP TABLE IF EXISTS TagJump CASCADE;
DROP TABLE IF EXISTS TransactionJump CASCADE;
DROP TABLE IF EXISTS TransactionType CASCADE;
DROP TABLE IF EXISTS UserJump CASCADE;
DROP TABLE IF EXISTS UserStaff CASCADE;
